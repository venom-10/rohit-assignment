    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="cartoon-card max-w-sm w-full bg-white md:max-w-md lg:max-w-lg">
          ...
          <div className="bg-cartoon-yellow border-4 border-black rounded-xl p-3 md:p-4 lg:p-6 mb-4 md:mb-6">
            <p className="text-center text-base md:text-lg lg:text-xl font-bold">
              You've been challenged by{' '}
              <span className="font-bubblegum text-lg md:text-xl lg:text-2xl">
                {challengeData.challenger}
              </span>!
            </p>
            <p className="text-center mt-2 md:mt-3 lg:mt-4 text-base md:text-lg lg:text-xl font-bold">
              Their score:{' '}
              <span className="font-bubblegum text-lg md:text-xl lg:text-2xl">
