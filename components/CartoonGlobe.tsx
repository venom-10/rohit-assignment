...
const CartoonGlobe: React.FC<{ className?: string }> = ({ className = "w-20 h-20" }) => {
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="absolute top-1/4 left-1/4 w-1/2 h-1/2 bg-cartoon-green rounded-full border-2 border-black"></div>
      <div className="absolute top-1/3 right-1/4 w-1/4 h-1/4 bg-cartoon-yellow rounded-full border-2 border-black"></div>
